...
class HistoryItem extends React.Component {
  render() {
    ...
    const diff =
      this.props.diff && this.props.diff !== null && this.props.diff.length > 0
        ? JSON.parse(this.props.diff)
        : {};

    return (
      <div className="comments__item on">
        <div className="comments__item-avatar">
          <div className="comments__item-avatar-img"></div>
        </div>
        ...
        <div className="comments__item-title">
          ...
          <StripedList
            key={1}
            style={{
              gridTemplateColumns: "120px 100px 140px 140px 1fr 150px 40px",
              marginTop: "10px",
            }}
          >
