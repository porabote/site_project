...
import FeedFilter from "./ObjectsFeedFilter";
import {greedMap} from "./ObjectsFeedConfig";
...
const Feed = () => {
  ...
  return (
    <div className="feed-widget">
      ...
      <Pagination/>
      <Greed map={greedMap} linkTo="/objects/view/:id" records={records} class="feed striped">
        <GreedColumn
          name="name_en"
